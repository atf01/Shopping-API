...
var OrderModel = /** @class */ (function () {
    ...
    OrderModel.prototype.getOrders = function (user_id) {
    ...
    OrderModel.prototype.getCurrentOrderByUserId = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, ordersSql, order, productsSql, products, produtcsIdAndQuanty, result, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 3:
                        products = _a.sent();
                        produtcsIdAndQuanty = products.rows.reduce(function (prev, curr) {
    ...
    OrderModel.prototype.fetchAllActiveOrdersByUserId = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OrderModel.prototype.getCompletedOrdersByUserId = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // update an order
    OrderModel.prototype.updateOrderStatus = function (status, order_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [status, order_id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
