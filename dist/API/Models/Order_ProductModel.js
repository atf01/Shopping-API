...
var OrderProductsModel = /** @class */ (function () {
    ...
    OrderProductsModel.prototype.AddProductToOrder = function (newProductOrder) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [newProductOrder.order_id, newProductOrder.product_id, newProductOrder.quantity])];
                    case 2:
                        result = _a.sent();
                        conn.release();
