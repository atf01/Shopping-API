        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, userModel.fetchUserById(1)];
                case 1:
                    data = _a.sent();
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    conn = _a.sent();
                    trancuate = 'TRUNCATE TABLE users RESTART IDENTITY CASCADE';
                    return [4 /*yield*/, conn.query(trancuate)];
                case 2:
                    _a.sent();
                    conn.release();
                    return [3 /*break*/, 4];
