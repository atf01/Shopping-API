...
var Order_ProductModel_1 = __importDefault(require("../../API/Models/Order_ProductModel"));
...
var orderProductsModel = new Order_ProductModel_1.default();
...
describe('orderProducts Model', function () {
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var conn, sql_users, sql_products, sql_orders, sql_order_products, err_1, user, proudct, order;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    conn = _a.sent();
                    sql_users = 'TRUNCATE TABLE products RESTART IDENTITY CASCADE';
    ...
    it('test add product to order', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderProductsModel.AddProductToOrder({
                        order_id: 1,
                        product_id: 1,
                        quantity: 5,
                    })];
