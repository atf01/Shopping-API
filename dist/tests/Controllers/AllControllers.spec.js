...
describe('testing all app endpoints', function () {
    ...
    describe('users endpoints test', function () {
        afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, DatabaseAdapter_1.default.getInstance().getClient().connect()];
                    case 1:
                        conn = _a.sent();
                        sql = 'TRUNCATE TABLE  users,products,orders,order_products RESTART IDENTITY CASCADE';
        ...
        it('test create first to get token', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('test get user by id with correct token', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('test get user by id with false token', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/users/1').set('Authorization', "Bearer asdk;4flsdfweif")];
                    case 1:
                        response = _a.sent();
    ...
    describe('products endpoints test', function () {
        it('test creating products endpoint', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request.post('/products').
                                send(product).
                                set('Authorization', "Bearer ".concat(token))];
                    case 1:
                        response = _a.sent();
        ...
        it('test getting all products endpoint', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request
    ...
    describe('orders endpoints test', function () {
